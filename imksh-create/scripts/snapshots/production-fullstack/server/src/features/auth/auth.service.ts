...
import { sendOtpEmail } from "../../common/utils/emailOtp.js";
import { uploadSingleToCloudinary, deleteFromCloudinary } from "../../common/utils/cloudinaryUpload.js";
import logger from "../../config/logger.js";
export const signup = async ({ name, email, phone, password }: any) => {
...
export const updateProfile = async (userId: any, { name, phone, file }: any) => {
    const user = await prisma.user.findUnique({
      where: { id: userId },
    });
    if (!user) {
